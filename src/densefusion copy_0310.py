                ...
                for idx in range(len(lst)):
                    ...
                    try:
                        ...
                        if matching_distance < 0.1:
                            ...
                            # interesting_pixels_y = interesting_pixels[1][interesting_pixels[1] - rmin < rmax - rmin]
                            # interesting_pixels_x = interesting_pixels[0][interesting_pixels[0] - cmin < cmax - cmin]
                            ...
                            # print interesting_pixels[1][interesting_pixels[1] - rmin < rmax - rmin]
                            # print cmin, rmin, cmax, rmax
                            # print cnn_img.shape
                            # interesting_cnn_feature = cnn_img[:, interesting_pixels[0][interesting_pixels[0] - cmin < cmax - cmin] - cmin, \
                            #                                     interesting_pixels[1][interesting_pixels[1] - rmin < rmax - rmin] - rmin]
                            # print "interesting_pixels shape : " + interesting_pixels.shape
