...
class Densefusion:
    ...
    def densefusion(self):
        ...
        # for now in range(2110, 2121):   # Scene 10
        ...
        # for now in range(2600, 2949):   # Scene1 for test.
            if not rospy.is_shutdown():
                ...
                # # c_quat[2] = 0
                # # c_quat[3] = 1
                # # r = Rotation.from_quat(c_quat)
                # print quaternion_matrix(c_quat)
                ...
                point_cloud = xyzrgb_array_to_pointcloud2(pred_points[:,:3], pred_colors, frame_id="map")
                ...
                if interesting_points[0] is not None:
                    interesting_point_cloud = xyzrgb_array_to_pointcloud2(interesting_points[0][:,:3], interesting_colors[0], frame_id="map")
