...
ycb_dataset = dataset_base.copy({
    ...
    'train_images': './data/ycb/train/img',
    'valid_images': './data/ycb/val/img',

    'train_info': './data/ycb/train/train.json',
    'valid_info': './data/ycb/val/val.json',

    'class_names': YCB_CLASSES,
})
...
yolact_ycb_config = yolact_resnet50_config.copy({
    'name': "yolact_resnet50",  # Will default to yolact_resnet50_pascal

    # Dataset stuff
    'dataset': ycb_dataset,
    'num_classes': len(ycb_dataset.class_names) + 1,
...
yolact_plus_ycb_config = yolact_plus_resnet50_config.copy({
    'name': "yolact_resnet50",  # Will default to yolact_resnet50_pascal
